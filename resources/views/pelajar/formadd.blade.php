        ...
        <div class="card-body">
            <form action="{{ url('pelajar') }}" method="POST">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control form-control-sm @error('txtnamalengkap') is-invalid @enderror" id="txtnamalengkap" name="txtnamalengkap" value="{{ old('txtnamalengkap') }}">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-5">
                        <select name="txtjeniskelamin" id="txtjeniskelamin" class="form-control form-control-sm @error('txtjeniskelamin') is-invalid @enderror">
                            ...
                            <option value="M" {{ old('txtjeniskelamin') == 'M' ? 'selected' : '' }}>Pria</option>
                            <option value="F" {{ old('txtjeniskelamin') == 'F' ? 'selected' : '' }}>Wanita</option>
                        </select>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control form-control-sm @error('txtalamat') is-invalid @enderror" id="txtalamat" name="txtalamat" value="{{ old('txtalamat') }}">
                        @error('txtalamat')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control form-control-sm @error('txtnohp') is-invalid @enderror" id="txtnohp" name="txtnohp" value="{{ old('txtnohp') }}">
                        @error('txtnohp')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
